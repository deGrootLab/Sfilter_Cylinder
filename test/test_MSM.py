...
class MyTestCase(unittest.TestCase):
    ...
    def test_mfpt_kinetic_model(self):
        ...
        self.assertListEqual(model.passage_time_length_alltraj[0][0][1][:2].tolist(), mfpt_01[:2])
        self.assertListEqual(model.passage_time_length_alltraj[1][0][1].tolist(), mfpt_01[2:])
